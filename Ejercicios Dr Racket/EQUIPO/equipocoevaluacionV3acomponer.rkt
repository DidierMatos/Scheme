...
(define (SumLiPreg1 const v1)
  (display "¿El alumno cumplió con las actividades propuestas?")
  (+ const v1))
(SumLiPreg1 const v1)

(define (SumLiPreg2 const v2)
  (display "¿El alumno cumplió con las actividades propuestas2?")
  (+ const v2))
(SumLiPreg2 const v2)

(define (SumLiPreg3 const v3)
  (display "¿El alumno cumplió con las actividades propuestas3?")
  (+ const v3))
(SumLiPreg3 const v3)

(define (SumLiPreg4 const v4)
  (display "¿El alumno cumplió con las actividades propuestas4?")
  (+ const v4))
(SumLiPreg4 const v4)
