...
(printf " C) Si el número ingresado es menor a 20 te imprimira el valor de true, de lo contrario sera falso")
(define (numero x)
  ( < x 20));función que evaluara si el numero es menor a 20
(numero (read))

(printf " D)Si el numero es mayor o igual a 10 y menor que 20 te imprimira true, de lo contrario sera falso")
(define (numero x)
  (and (or (<= x 10 ) (< x 20))));función que evaluara si el numero es mayor o igual a 10 y menor que 20
(numero (read))

(printf " E)Si el numero es mayor o igual a 10 y menor que 20 o es mayor a 30 te imprimira true, de lo contrario sera falso")
(define (numero x)
